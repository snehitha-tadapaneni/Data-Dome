...
data_final <- data_final %>% 
  filter(Android.Ver != 'NaN')



ggplot(data_final, aes(x = Android.Ver)) + 
  geom_bar(binwidth = 0.5, fill = "#1f3374", color='#efefef') + 
...
ggplot(data_final, aes(x = Price, y = Rating,color = log(data_final$Installs))) +
...
ggplot(data_final, aes(x = Price, y = Reviews,color = log(data_final$Installs))) +
  geom_point(alpha = 0.6) +
