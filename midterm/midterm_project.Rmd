...
# 1. Days Since Last Update vs Rating
ggplot(data_updated, aes(x = Days.Since.Last.Update, y = Rating)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "lm", color = "blue", se = FALSE) +
  labs(title = "Correlation between Days Since Last Update and Rating",
       x = "Days Since Last Update",
       y = "Rating")

# 2. Days Since Last Update vs Reviews
ggplot(data_updated, aes(x = Days.Since.Last.Update, y = Reviews)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "lm", color = "red", se = FALSE) +
  labs(title = "Correlation between Days Since Last Update and Reviews",
       x = "Days Since Last Update",
       y = "Reviews")

# 3. Days Since Last Update vs Installs
ggplot(data_updated, aes(x = Days.Since.Last.Update, y = Installs)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "lm", color = "green", se = FALSE) +
  labs(title = "Correlation between Days Since Last Update and Installs",
       x = "Days Since Last Update",
       y = "Installs")

# 4. Content Rating Encoded vs Rating
ggplot(data_updated, aes(x = Content.Rating.Encoded, y = Rating)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "lm", color = "purple", se = FALSE) +
  labs(title = "Correlation between Content Rating Encoded and Rating",
       x = "Content Rating Encoded",
       y = "Rating")

# 5. Content Rating Encoded vs Reviews
ggplot(data_updated, aes(x = Content.Rating.Encoded, y = Reviews)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "lm", color = "orange", se = FALSE) +
  labs(title = "Correlation between Content Rating Encoded and Reviews",
       x = "Content Rating Encoded",
       y = "Reviews")

# 6. Content Rating Encoded vs Installs
ggplot(data_updated, aes(x = Content.Rating.Encoded, y = Installs)) +
  geom_point(alpha = 0.5) +
  geom_smooth(method = "lm", color = "brown", se = FALSE) +
  labs(title = "Correlation between Content Rating Encoded and Installs",
       x = "Content Rating Encoded",
       y = "Installs")
