...
trainData <- data_updated[trainIndex, ]  # Use 'data_updated' here
...
rf_model <- randomForest(
  Installs_Category ~ Rating + Reviews + Size + Price + content_rating + lastupdate +
             catART_AND_DESIGN + catGAME + catPRODUCTIVITY +
             catBUSINESS + catEDUCATION,
  data = trainData,
