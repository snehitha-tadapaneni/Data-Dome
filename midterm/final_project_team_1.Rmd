...
conf_matrix <- confusionMatrix(rf_predictions, testData$Installs_Category)
...
precision <- conf_matrix$byClass['Precision']  # Or Positive Predictive Value
recall <- conf_matrix$byClass['Recall']        # Or Sensitivity
