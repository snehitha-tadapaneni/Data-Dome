---
title: "DATS 6101 - Google playstore apps "
date: "`r Sys.Date()`"
...
Our research focuses on exploring the features of Size, installs, reviews,rating, Category, content rating, and Price on apps on Google Play Store and using different algorithms to identify the most influential attributes of highly installed apps on Google Play Store.
...
X <- data_apps[, !names(data_apps) %in% c('Installs', 'Installs_Category', 'Installs_Num')]
